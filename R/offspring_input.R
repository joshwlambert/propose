...
offspring_input <- function(ns, ...) {
  ...
  offspring_tip <- "The probability distribution governing the number of
              ...
              via the dispersion parameter k; Poisson assumes homogeneous
              transmission; Geometric has more heterogeneity in transmission
              than Poisson, and is a special case of the Negative Binomial
              with k = 1."
  ...
  disp_tip <- "The dispersion parameter (k) of the Negative Binomial offspring
              distribution. Lower values indicate greater heterogeneity in
              transmission (i.e. more superspreading), while k = 1 is the same
              as the Geometric and large values of k approximate a
